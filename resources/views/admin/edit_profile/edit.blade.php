    ...
    <div class="row g-4 justify-content-center">
        <div class="col-sm-12 col-xl-12">
            <div class="bg-light rounded p-4">
                <form action="{{ route('edit_profile.update', ['user' => $user->id]) }}" method="POST" enctype="multipart/form-data">
                @method('PATCH')
                @csrf
                        <div class="row g-4 mb-4">
                            <div class="col-sm-12 col-lg-6">
                                <div class="">
                                    <small>*kosongi jika tidak mau merubah foto</small> <br>
                                </div>
                                <div class="mb-2 @error('foto') has-error @enderror">
                                    <label for="foto" class="form-label mt-2">Foto 1</label>
                            ...
                            <div class="col-sm-12 col-lg-6">
                                ...
                                <div class="mb-3 @error('password') has-error @enderror">
                                    ...
                                    <small>*Kosongi jika tidak mau mengganti password</small>
                                    <input type="text" name="password" value="{{ old('password') }}" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp">
                                        @error('password')
                                        <small>{{$message}}</small>
                                        @enderror
