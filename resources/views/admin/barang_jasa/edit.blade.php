    ...
    <div class="row g-4 justify-content-center">
        ...
        <div class="col-sm-12 col-xl-12">
            <div class="bg-light rounded p-4">
                <form action="{{ route('barang_jasa.update', ['barang_jasa' => $barang_jasa->id]) }}" method="POST" enctype="multipart/form-data">
                @method('PATCH')
                @csrf
                        ...
                        <small>*foto, foto1, foto2 silahkan di kosongi jika tidak mau merubah</small>
                            <div class="col-sm-12 col-lg-6">
                                <div class="mb-5 @error('foto_utama') has-error @enderror">
                                    ...
                                    <img id="preview-image-before-upload" class="position-relative mt-2 w-100" src="{{asset('img/barang_jasa/'.$barang_jasa->foto_utama)}}"
                                ...
                                <div class="mb-2 @error('foto_1') has-error @enderror">
                                    ...
                                    <img id="preview-image-before-upload1" class="position-relative mt-2" src="{{asset('img/barang_jasa/'.$barang_jasa->foto1)}}"
                                ...
                                <div class="mb-3 @error('foto_2') has-error @enderror">
                                    ...
                                    <img id="preview-image-before-upload2" class="position-relative mt-2" src="{{asset('img/barang_jasa/'.$barang_jasa->foto2)}}"
                                        alt="_belum foto ada yang di unggah" style="max-height : 100px;">
                                    @error('foto_2')
                                        <br><small>{{$message}}</small>
                                    @enderror
                            ...
                            <div class="col-sm-12 col-lg-6">
                                <div class="mb-3 @error('nama') has-error @enderror">
                                    ...
                                    <input type="text" name="nama" value="{{ old('nama') ?? $barang_jasa->nama }}" class="form-control" id="exampleInputEmail1"
                                ...
                                <div class="mb-3 @error('keterangan') has-error @enderror">
                                    ...
                                    <textarea class="form-control" name="keterangan" placeholder="Berikan deskripsi iklan disini"
                                        id="floatingTextarea" style="height: 150px;">{{ old('keterangan') ?? $barang_jasa->deskripsi }}</textarea>
                                    @error('keterangan')
                                        <small>{{$message}}</small>
                                    @enderror
                                </div>
                                <div class="mb-3 @error('harga') has-error @enderror">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="harga" id="hargaInput" value="{{ old('harga') ?? $barang_jasa->harga }}" class="form-control" >
                                    </div>
                                    @error('harga')
                                        <small>{{$message}}</small>
                                    @enderror
                                ...
                                <div class="mb-3 @error('penawaran') has-error @enderror">
                                    ...
                                    <input type="text" name="penawaran" value="{{ old('penawaran') ?? $barang_jasa->penawaran }}" class="form-control" id="exampleInputEmail1">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="tipe" class="form-select mb-3" aria-label="Default select example">
                                        <option value="produk" {{(old('tipe') ?? $barang_jasa->type) == 'produk' ? 'selected' : ''}}>Produk</option>
                                        <option value="jasa" {{(old('tipe') ?? $barang_jasa->type) == 'jasa' ? 'selected' : ''}}>Jasa</option>
                                    </select>
                                </div>
                                <div class="mb-3 @error('satuan') has-error @enderror">
                                    ...
                                    <input type="text" name="satuan" class="form-control" value="{{old('satuan') ?? $barang_jasa->satuan}}" id="exampleInputEmail1">
                                    @error('satuan')
                                        <small>{{$message}}</small>
                                    @enderror
                                </div>
                                <div class="mb-3 @error('pengiriman') has-error @enderror">
                                    ...
                                    <input type="text" name="pengiriman" value="{{old('pengiriman') ?? $barang_jasa->pengiriman}}" class="form-control" id="exampleInputEmail1">
                                    @error('pengiriman')
                                        <small>{{$message}}</small>
                                    @enderror
                                </div>
                                <div class="mb-3 @error('narahubung_wa') has-error @enderror">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="number" name="narahubung_wa" value="{{ old('no_wa') ?? $barang_jasa->narahubung_wa }}" class="form-control" >
                                    </div>
                                    @error('narahubung_wa')
                                        <small>{{$message}}</small>
                                    @enderror
