                            ...
                            <div class="col-sm-12 col-lg-6">
                                ...
                                <div class="mb-3 @error('harga') has-error @enderror">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="number" name="harga" value="{{ old('harga') ?? $iklan_utama->harga }}" class="form-control" >
                                    </div>
                                    @error('harga')
                                        <small>{{$message}}</small>
                                    @enderror
                                ...
                                <div class="mb-3 @error('diskon') has-error @enderror">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="number" name="diskon" value="{{ old('diskon') ?? $iklan_utama->diskon }}" class="form-control" >
