...
<div class="container-fluid pt-4 px-4">
    <div class="row g-4 justify-content-center">
        <strong>Iklan Utama > Edit Data</strong>
        <div class="col-sm-12 col-xl-12">
            <div class="bg-light rounded p-4">
                <form action="{{ route('iklan_utama.update', ['iklan_utama' => $iklan_utama->id]) }}" method="POST" enctype="multipart/form-data">
                @method('PATCH')
                @csrf
                        ...
                        <small>*foto, foto1, foto2 silahkan di kosongi jika tidak mau merubah</small>
                            <div class="col-sm-12 col-lg-6">
                                <div class="mb-5 @error('foto_utama') has-error @enderror">
                                    ...
                                    <img id="preview-image-before-upload" class="position-relative mt-2 w-100" src="{{asset('img/iklan_utama/'.$iklan_utama->foto_utama)}}"
                                ...
                                <div class="mb-2 @error('foto_1') has-error @enderror">
                                    ...
                                    <img id="preview-image-before-upload1" class="position-relative mt-2" src="{{asset('img/iklan_utama/'.$iklan_utama->foto1)}}"
                                ...
                                <div class="mb-3 @error('foto_2') has-error @enderror">
                                    ...
                                    <img id="preview-image-before-upload2" class="position-relative mt-2" src="{{asset('img/iklan_utama/'.$iklan_utama->foto2)}}"
                                        alt="_belum foto ada yang di unggah" style="max-height : 100px;">
                                    @error('foto_2')
                                        <br><small>{{$message}}</small>
                                    @enderror
                            ...
                            <div class="col-sm-12 col-lg-6">
                                <div class="mb-3 @error('nama') has-error @enderror">
                                    ...
                                    <input type="text" name="nama" value="{{ old('nama') ?? $iklan_utama->nama }}" class="form-control" id="exampleInputEmail1"
                                ...
                                <div class="mb-3 @error('keterangan') has-error @enderror">
                                    ...
                                    <textarea class="form-control" name="keterangan" placeholder="Berikan deskripsi iklan disini"
                                        id="floatingTextarea" style="height: 150px;">{{ old('keterangan') ?? $iklan_utama->keterangan }}</textarea>
                                    @error('keterangan')
                                        <small>{{$message}}</small>
                                    @enderror
                                </div>
                                <div class="mb-3 @error('harga') has-error @enderror">
                                    ...
                                    <input type="number" name="harga" value="{{ old('harga') ?? $iklan_utama->harga }}" class="form-control" id="exampleInputEmail1">
                                    @error('harga')
                                        <small>{{$message}}</small>
                                    @enderror
                                </div>
                                <div class="mb-3 @error('diskon') has-error @enderror">
                                    ...
                                    <input type="number" name="diskon" value="{{ old('diskon') ?? $iklan_utama->diskon }}" class="form-control" id="exampleInputEmail1">
                                    @error('diskon')
                                        <small>{{$message}}</small>
                                    @enderror
                                </div>
                                <div class="mb-3 @error('penawaran') has-error @enderror">
                                    ...
                                    <input type="text" name="penawaran" value="{{ old('penawaran') ?? $iklan_utama->penawaran }}" class="form-control" id="exampleInputEmail1">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="tipe" class="form-select mb-3" aria-label="Default select example">
                                        <option value="produk" {{(old('tipe') ?? $iklan_utama->type) == 'produk' ? 'selected' : ''}}>Produk</option>
                                        <option value="jasa" {{(old('tipe') ?? $iklan_utama->type) == 'jasa' ? 'selected' : ''}}>Jasa</option>
                                    </select>
                                </div>
                            </div>
                        </div>
