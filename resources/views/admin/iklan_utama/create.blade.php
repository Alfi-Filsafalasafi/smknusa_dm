    ...
    <div class="row g-4 justify-content-center">
        ...
        <div class="col-sm-12 col-xl-12">
            <div class="bg-light rounded p-4">
                <form action="{{route('iklan_utama.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                        <div class="row g-4 mb-4">
                            ...
                            <div class="col-sm-12 col-lg-6">
                                ...
                                <div class="mb-3 @error('harga') has-error @enderror">
                                    ...
                                    <input type="number" name="harga" value="{{old('harga')}}" class="form-control" id="exampleInputEmail1">
                                    @error('harga')
                                        <small>{{$message}}</small>
                                    @enderror
                                </div>
                                <div class="mb-3 @error('diskon') has-error @enderror">
                                    ...
                                    <input type="number" name="diskon" value="{{old('diskon')}}" class="form-control" id="exampleInputEmail1">
                                    @error('diskon')
                                        <small>{{$message}}</small>
                                    @enderror
                                </div>
