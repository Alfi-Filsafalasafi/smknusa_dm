                        ...
                        <small>*foto, foto1, foto2 silahkan di kosongi jika tidak mau merubah</small>
                            ...
                            <div class="col-sm-12 col-lg-6">
                                ...
                                <div class="mb-3 @error('harga') has-error @enderror">
                                    ...
                                    <input type="number" name="harga" value="{{ old('harga') ?? $iklan_jurusan->harga }}" class="form-control" id="exampleInputEmail1">
                                    @error('harga')
                                        <small>{{$message}}</small>
                                    @enderror
                                </div>
                                <div class="mb-3 @error('diskon') has-error @enderror">
                                    ...
                                    <input type="number" name="diskon" value="{{ old('diskon') ?? $iklan_jurusan->diskon }}" class="form-control" id="exampleInputEmail1">
                                    @error('diskon')
                                        <small>{{$message}}</small>
                                    @enderror
                                </div>
