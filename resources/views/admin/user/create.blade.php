                        ...
                        <div class="row g-4 mb-4">
                            <div class="col-sm-12 col-lg-6">
                                <div class="mb-2 @error('foto') has-error @enderror">
                                    ...
                                    <img id="preview-image-before-upload1" class="position-relative mt-2" src=""
                            ...
                            <div class="col-sm-12 col-lg-6">
                                <div class="mb-3 @error('nip') has-error @enderror">
                                    ...
                                    <input type="number" name="nip" value="{{ old('nip')}}" class="form-control" id="exampleInputEmail1"
                                ...
                                <div class="mb-3 @error('no_wa') has-error @enderror">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="number" name="no_wa" value="{{ old('no_wa') }}" class="form-control" >
                                    </div>
                                    @error('no_wa')
                                    <small>{{$message}}</small>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="jurusan" id="jurusan" class="form-select mt-2">
